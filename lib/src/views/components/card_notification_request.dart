...
class NotificationRequestCard extends StatefulWidget {
  ...
  @override
  State<NotificationRequestCard> createState() =>
      _NotificationRequestCardState();
}

class _NotificationRequestCardState extends State<NotificationRequestCard> {
  ...
  Widget build(BuildContext context) {
    ...
    var profileCircle = ProfileCircle(
      ...
      notificationTypeIcon: Icons.remove_from_queue_sharp,
    );
