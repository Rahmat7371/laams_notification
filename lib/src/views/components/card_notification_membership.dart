...
class NotificationMembershipCard extends StatefulWidget {
  const NotificationMembershipCard({
    super.key,
    required this.title,
  ...
  @override
  State<NotificationMembershipCard> createState() =>
      _NotificationMembershipCardState();
}

class _NotificationMembershipCardState
    extends State<NotificationMembershipCard> {
  ...
  Widget build(BuildContext context) {
    ...
    var profileCircle = ProfileCircle(
      ...
      notificationTypeIcon: Icons.card_membership,
    );
